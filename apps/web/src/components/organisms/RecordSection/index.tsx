	...
	return (
		<div className={`flex flex-col items-center gap-6 ${className}`}>
				...
				<div className="animate-fade-in">
					<div className="rounded-full border border-white/20 bg-white/80 px-4 py-2 shadow-lg backdrop-blur-xl">
						<p className="font-medium text-gray-700 text-sm">
							録音中...{" "}
							<span className="font-bold text-red-500">{remainingTime}秒</span>
						</p>
					</div>
				</div>
			)}
			...
			{status === "processing" && (
				<div className="animate-fade-in">
					<div className="rounded-full border border-white/20 bg-white/80 px-4 py-2 shadow-lg backdrop-blur-xl">
						<p className="font-medium text-purple-700 text-sm">音を分析中...</p>
					</div>
				</div>
			)}
			...
			{status === "completed" && (
				<div className="animate-fade-in">
					<div className="rounded-full border border-white/20 bg-white/80 px-4 py-2 shadow-lg backdrop-blur-xl">
						<p className="font-medium text-green-700 text-sm">✓ 録音完了</p>
					</div>
				</div>
			)}
		</div>
